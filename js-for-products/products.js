                ...
                <div class="col-xl-9 col-lg-8 col-md-7" style="background-color: #ececec;padding: 0;">
                 ...
                 <div class="filter-bar d-flex flex-wrap align-items-center">
                      ...
                      <div class="pagination" id="pagination">
                        ...
                        <a href="#" onclick="showAllProductForUser(${++page})">2</a>
                        <a href="#" onclick="showAllProductForUser(${++page})">3</a>
    ...
    axios.get('http://localhost:8080/products')
        ...
        .then(async function (response) {
            ...
            for (let i = 0; i < products.length; i++) {
                html += `
                 <div class="col-lg-4 col-md-6" style="    border: 1px solid pink;">
